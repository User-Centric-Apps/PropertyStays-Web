                ...
                <div class="d-sm-flex flex-wrap justify-content-between align-items-center border-bottom">
                  ...
                  <div class="py-2">
                    <div class="d-flex flex-nowrap align-items-center pb-3">
                      <a class="btn btn-primary btn-shadow d-block w-100" href="{{ url('host/add-tour') }}"><i class="ci-add fs-lg me-2"></i> Add Tour</a>
                    </div>
                    </div>
                  </div>
                </div>
                ...
                @foreach($items as $item)
                  <div class="d-block d-sm-flex align-items-center py-4 border-bottom">
                    <a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="{{ url('rental/'.$item->slug) }}" style="width: 12.5rem;">
                      <img class="rounded-3" src="{{ URL::asset('storage/app/public/uploads/tours/'.$item->image) }}" alt="Awaiting Photo">
                    </a>
                    <div class="text-center text-sm-start">
                      ...
                      <div class="d-flex justify-content-center justify-content-sm-start pt-3">
                        <a href="{{ url('host/view-tour/'.$item->id) }}" class="btn bg-faded-success btn-icon me-2" title="View">
                          <i class="ci-eye text-info"></i>
                        </a>
                        <a href="{{ url('host/add-tour/'.$item->id) }}" class="btn bg-faded-info btn-icon me-2" title="Edit">
                          <i class="ci-edit text-info"></i>
                        </a>
                        <a href="{{ url('host/tour/destroy/'.$item->id) }}" class="btn bg-faded-danger btn-icon" title="Delete">
