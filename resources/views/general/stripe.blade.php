        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ url('stripe-payment') }}" method="post" class="validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_51JP2q5HtoAefYlJfnvVtKd76u4tJT4ppRKUo7SZ0NZeDbYOBj9ETYuYeQnG1cwBx0F2FbwsmaoksHm8l8xD1mril00L8LEWpZh" id="payment-form">
                        @csrf
                        ...
                        <div class='form-row row'>
                            ...
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Expiration Month</label> <input
                                    class='form-control card-expiry' placeholder='MM' size='7'
                                    type='text'>
                            </div>
                        </div>
...
$(function() {
  ...
  $('form.validation').bind('submit', function(e) {
    ...
    if (!$form.data('cc-on-file')) {
      ...
      var exp_years = expirys.slice(3, 7);
      console.log(expirys);
      console.log(exp_months);
