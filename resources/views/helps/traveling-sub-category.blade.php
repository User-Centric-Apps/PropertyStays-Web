                ...
                <ol class="breadcrumb justify-content-start py-2">
                  ...
                  <li class="breadcrumb-item">
                    <a class="text-nowrap" href="{{ url('traveling-help')}}">
                      <i class="lead text-muted pt-1"></i> Traveling Help
                    </a>
                  </li>
                  ...
                  <div class="col-lg-6 col-sm-6 mb-grid-gutter">
                    <div class="card border-0 shadow">
                      <div class="card-body text-center">
                        ...
                        <a class="btn btn-outline-primary btn-sm stretched-link mb-2" href="{{ url('traveling-help/sub-category-list/'.$item->slug)}}">
                          Learn more
                        </a>
                      </div>
                    </div>
