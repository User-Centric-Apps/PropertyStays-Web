                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/staff/manage')}}" class="btn green btn-sm btn-outline " > <i class="fa fa-plus"></i> Add Staff
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Staff list
...
jQuery(document).ready(function() {
...

    {
      ...
      $.ajax({
        ...
        url: base_url+"/admin/staff/destroy/"+c_id,
