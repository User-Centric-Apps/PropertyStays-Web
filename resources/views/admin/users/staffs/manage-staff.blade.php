        ...
        <div class="page-bar">
            ...
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{ url('admin/staffs')}}">Staff</a>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Manage Staff</span>
                    ...
                    <div class="portlet-body">
                        ...
                        <form action="{{ url('admin/staff/save') }}" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                            {{ Form::select('type', array(2 => 'Admin',3 => 'Editor'), isset($user->type) ? $user->type : old('type'), ['class' => 'select form-control', 'id' => 'type', 'placeholder' => 'Select User Type', 'required' => 'required']) }} 
