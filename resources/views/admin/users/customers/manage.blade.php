        ...
        <div class="page-bar">
            ...
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{ url('admin/Travellers')}}">Travellers</a>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Manage Traveller</span>
                    ...
                    <div class="portlet-body">
                        ...
                        <form action="{{ url('admin/customers/save') }}" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" value="{{ isset($user->email) ? $user->email : old('email')}}" name="email" class="form-control" placeholder="Email Address"> </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" required="required" name="password" value="{{ isset($user->view_pass) ? $user->view_pass : old('password')}}" />
