                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/customers/manage')}}" class="btn green btn-sm btn-outline " > <i class="fa fa-plus"></i> Add Traveller
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Travellers list
...
jQuery(document).ready(function() {  
...

    {
      ...
      $.ajax({
        ...
        url: base_url+"/admin/customers/destroy/"+c_id,
