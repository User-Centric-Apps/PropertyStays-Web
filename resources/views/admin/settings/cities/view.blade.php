                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/cities/manage')}}" class="btn green btn-sm btn-outline " > <i class="fa fa-plus"></i> Add City
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Cities
...
jQuery(document).ready(function() {
        ...
        $('#ok_button').click(function()
        {
            ...
            $.ajax({
                ...
                url: base_url+"/admin/cities/destroy/"+c_id,
