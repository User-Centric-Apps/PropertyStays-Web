                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/suitable/manage')}}" class="btn green btn-sm btn-outline " > <i class="fa fa-plus"></i> Add Suitable
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Suitables
...
jQuery(document).ready(function() {
        ...
        var oTable = jQuery('#all_Table').DataTable({
            ...
            ajax: "{!! url('admin/suitables') !!}",

            columns: [

                { data: 'id', name: 'id' },

                { data: 'suitable_name', name: 'suitable_name' },

                {
                    ...
                    render: function(data, type, full, meta)
                    {
                        if(data)
                        {
                            return "<img src={{ URL::to('/') }}/storage/app/public/uploads/suitables/" + data + " width='70' class='img-thumbnail' />";
                        }
                        else
                        {
                            return "No Image ";
        ...
        $('#ok_button').click(function()
        {
            ...
            $.ajax({
                ...
                url: base_url+"/admin/suitable/destroy/"+c_id,
