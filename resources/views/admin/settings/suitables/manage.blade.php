        ...
        <div class="page-bar">
            ...
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{ url('admin/suitables')}}">Suitables</a>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Manage Suitable</span>
                    ...
                    <div class="portlet-body">
                        ...
                        <form action="{{ url('admin/suitable/save') }}" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="suitable_name" data-required="1" value="{{ isset($item->suitable_name) ? $item->suitable_name : old('suitable_name')}}" class="form-control" /> 
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            ...
                                            <div class="fileinput-new thumbnail" style="width: 96px; height: 96px;">
                                                ...
                                                <img src="{{ URL::to('/') }}/storage/app/public/uploads/suitables/{{ isset($item->image)?$item->image:'no-image.png' }}" width="96" height="96"> 
