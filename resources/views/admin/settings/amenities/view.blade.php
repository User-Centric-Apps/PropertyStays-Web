                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/amenities/manage')}}" class="btn green btn-sm btn-outline " > <i class="fa fa-plus"></i> Add Amenity
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Amenities
...
jQuery(document).ready(function() {
            ...
            columns: [
...

                {
                    ...
                    render: function(data, type, full, meta)
                    {
                        if(data)
                        {
                            return "<img src={{ URL::to('/') }}/storage/app/public/uploads/amenities/" + data + " width='70' class='img-thumbnail' />";
                        }
                        else
                        {
                            return "No Image ";
        ...
        $('#ok_button').click(function()
        {
            ...
            $.ajax({
                ...
                url: base_url+"/admin/amenities/destroy/"+c_id,
