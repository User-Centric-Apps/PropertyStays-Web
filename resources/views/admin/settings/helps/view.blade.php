                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/help/manage')}}" class="btn green btn-sm btn-outline " > <i class="fa fa-plus"></i> Add Help
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Helps
...
jQuery(document).ready(function() {
        ...
        var oTable = jQuery('#all_Table').DataTable({
            ...
            columns: [
                ...
                { data: 'sub_name', name: 'helps_sub_category.sub_name' },

                { data: 'name', name: 'helps_category.name' },

                { data: 'type', name: 'helps_category.type' },
        ...
        $('#ok_button').click(function()
        {
            ...
            $.ajax({
                ...
                url: base_url+"/admin/help/destroy/"+c_id,
