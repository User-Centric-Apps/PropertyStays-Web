                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/help-sub-categories/manage')}}" class="btn green btn-sm btn-outline " > 
                                        <i class="fa fa-plus"></i> Add Help Sub Category
                                    </a>
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Help Sub Categories
...
jQuery(document).ready(function() {
        ...
        var oTable = jQuery('#all_Table').DataTable({
            ...
            ajax: "{!! url('admin/help-sub-categories') !!}",
            ...
            columns: [
                ...
                { data: 'name', name: 'helps_category.name' },
        ...
        $('#ok_button').click(function()
        {
            ...
            $.ajax({
                ...
                url: base_url+"/admin/help-sub-categories/destroy/"+c_id,
