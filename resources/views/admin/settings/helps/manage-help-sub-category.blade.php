        ...
        <div class="page-bar">
            ...
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <a href="{{ url('admin/help-sub-categories')}}">Help Sub Categories</a>
                ...
                <li>
                    ...
                    <span>Manage Help Sub Category</span>
                ...
                <div class="portlet light portlet-fit portlet-form bordered">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark sbold uppercase">Help Sub Category</span>
                    ...
                    <div class="portlet-body">
                        ...
                        <form action="{{ url('admin/help-sub-categories/save') }}" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="sub_name" data-required="1" value="{{ isset($item->sub_name) ? $item->sub_name : old('sub_name')}}" class="form-control" required="required"  /> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="description" required="required" rows="7" class="form-control">{{ isset($item->description)  ? $item->description : old('description')}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {{ Form::select('help_cid', $helpcategories, isset($item->help_cid) ? $item->help_cid : old('help_cid'), ['class' => 'select form-control', 'id' => 'help_cid', 'required' => 'required']) }}
