...
<!-- BEGIN CONTENT BODY -->
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            ...
                            @if(Auth::guard('admin')->user()->blog_edit==1)
                            <div class="page-toolbar">

                                <div class="btn-group pull-right">

                                    <a href="{{ url('admin/blog/manage')}}" class="btn green btn-sm btn-outline" > <i class="fa fa-plus"></i> 
                                        Add New Blog
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject bold uppercase"> Blog
                                    </span>
...
jQuery(document).ready(function() {
    ...
    $('#ok_button').click(function()
    {
      ...
      $.ajax({
       ...
       url: base_url+"/admin/blog/delete/"+c_id,
