                        ...
                        <div class="page-bar">
                            ...
                            <div class="page-toolbar">
                                ...
                                <div class="btn-group pull-right">
                                    ...
                                    <a href="{{ url('admin/coupons/manage')}}" class="btn green btn-sm btn-outline" > <i class="fa fa-plus"></i> Add Coupon
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title">
                                        ...
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> Coupons list
...
jQuery(document).ready(function() {   
        ...
        var oTable = jQuery('#all_Table').DataTable({
            ...
            buttons: [
                ...
                { extend: 'print', title: "coupons List", className: 'btn dark btn-outline', text:"Print", exportOptions: { columns: [ 0, 1,2,3,4,5,6,7 ] }, customize: function ( win ) { $(win.document.body).css( 'background', '#fff' ); $(win.document.body).find('h1').css('text-align', 'center')}},
            ...
            columns: [
                ...
                { data: 'numc', name: 'numc', orderable: false, searchable: false },
...

    {
      ...
      $.ajax({
        ...
        url: base_url+"/admin/coupons/destroy/"+c_id,
