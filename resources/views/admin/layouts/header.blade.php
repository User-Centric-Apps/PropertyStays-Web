                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        ...
                        <a href="{{ url('admin/home') }}">
                            ...
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 573.3 118.8" width="150" class="logo-default margin-top-10" xml:space="preserve">
<style type="text/css">
        ...
        l22.5-12.2C93.2,78.6,93.2,77.3,92.8,76.6L92.8,76.6z"></path>
                    ...
                    <div class="top-menu">
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            $notifications_total = inActiveProp();
                            ...
                            <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                                ...
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span class="badge badge-default"> {{ $notifications_total }} </span>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="external">
                                        ...
                                        <h3>
                                            ...
                                            <span class="bold">{{ $notifications_total }} new notification!</span> 

                                        </h3>

                                        <a href="{{ url('admin/needs-approval') }}">view all</a>
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="padding-top: 2px; padding-bottom: 2px;">



                                    <div class="dropdown-user-inner" style="background: #fff;
    padding-left: 8px;">
                                        <span class="username username-hide-on-mobile"> 
                                            {{ Auth::user()->name }} 
                                        </span>
                                        <img alt="" src="{{ URL::asset('resources/assets/layouts/layout/img/avatar.png') }}" /> 
                                    </div>
